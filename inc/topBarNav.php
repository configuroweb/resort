...
<!-- Navbar -->
      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0 bg-dark text-light" id="login-nav">
        <div class="d-flex justify-content-between w-100">
          <div>
            <span class="mr-2"><i class="fab fa-whatsapp"></i> <a href="https://configuroweb.com/WhatsappMessenger" target="_blank"><?= $_settings->info('contact') ?></a></span>
          </div>
          <div>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a href="./?page=rooms" class="nav-link <?= isset($page) && $page =='rooms' ? "active" : "" ?>">Cuartos</a>
              </li>
              <li class="nav-item">
                <a href="./?page=activities" class="nav-link <?= isset($page) && $page =='activities' ? "active" : "" ?>">Atracciones</a>
              </li>
              <li class="nav-item">
                <a href="./?page=about" class="nav-link <?= isset($page) && $page =='about' ? "active" : "" ?>">Nosotros</a>
              </li>
              <li class="nav-item">
                <a href="./?page=contact_us" class="nav-link <?= isset($page) && $page =='contact_us' ? "active" : "" ?>">Contacto</a>
              </li>
